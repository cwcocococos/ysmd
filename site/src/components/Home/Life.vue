                ...
                <article>
                    <div class="swiper-container">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide"><img src="@/assets/images/sh-banner.jpg"/></div>
                            <div class="swiper-slide"><img src="@/assets/images/sh-banner2.jpg"/></div>
                            <div class="swiper-slide"><img src="@/assets/images/sh-banner3.jpg"/></div>
                        </div>
                        <!-- 如果需要分页器 -->
                        <div class="swiper-pagination"></div>
                    </div>
                    <div class="sj-tab">
                        <img src="@/assets/images/sh-tab.webp" alt="">
                    </div>
