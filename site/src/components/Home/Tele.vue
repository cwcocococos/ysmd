                ...
                <article>
                    <div class="swiper-container">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide"><img src="@/assets/images/jd-banner.webp"/></div>
                            <div class="swiper-slide"><img src="@/assets/images/jd-banner2.webp"/></div>
                            <div class="swiper-slide"><img src="@/assets/images/jd-banner3.webp"/></div>
                        </div>
                        <!-- 如果需要分页器 -->
                        <div class="swiper-pagination"></div>
                    </div>
                    <div class="sj-tab">
                        <img src="@/assets/images/jd-tab.webp" alt="">
                    </div>
